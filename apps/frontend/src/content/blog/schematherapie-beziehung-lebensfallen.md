...
faq:
  - question: "Was ist Schematherapie einfach erklärt?"
    answer: "Schematherapie wurde von Jeffrey Young entwickelt. Sie geht davon aus, dass wir in der Kindheit bestimmte Grundüberzeugungen über uns und die Welt entwickeln — sogenannte Schemata oder Lebensfallen. Wenn zentrale Bedürfnisse (Sicherheit, Verbindung, Autonomie, Selbstwert, Freiheit) nicht erfüllt wurden, entstehen maladaptive Schemata, die uns als Erwachsene in ungünstige Muster drängen."
  - question: "Wie viele Lebensfallen gibt es?"
    answer: "Young beschreibt 18 maladaptive Schemata, die er in 5 Domänen gruppiert: Abgetrenntheit und Ablehnung, beeinträchtigte Autonomie, beeinträchtigte Grenzen, Fremdbezogenheit, übertriebene Wachsamkeit. In Beziehungen sind besonders Verlassenheit, Misstrauen, Emotionale Entbehrung, Unzulänglichkeit und Unterwerfung relevant."
  - question: "Ist Schematherapie dasselbe wie CBT?"
    answer: "Nein, Schematherapie ist eine Weiterentwicklung der kognitiven Verhaltenstherapie (CBT). Young merkte, dass klassische CBT bei Persönlichkeitsstörungen und chronischen Mustern oft zu kurz griff. Er integrierte Bindungstheorie, emotionsfokussierte Arbeit, Gestalttherapie-Elemente wie den Stuhl-Dialog und Kindheitsarbeit. Das Ergebnis ist tiefer und körperorientierter als klassische CBT."
  - question: "Kann man Schemata ohne Therapeut bearbeiten?"
    answer: "Teilweise ja. Das Erkennen und Benennen von Schemata ist ein erster wichtiger Schritt, den du mit Büchern wie 'Sein Leben neu erfinden' (Young/Klosko) gut allein machen kannst. Tiefe Heilungsarbeit — besonders mit dem verletzten Kind-Modus und Imagination — gelingt jedoch zuverlässiger mit einer ausgebildeten Fachkraft."
  - question: "Was ist ein Schema-Modus?"
    answer: "Ein Modus ist der Zustand, in dem ein Schema aktuell aktiv ist. Young unterscheidet vier Modus-Gruppen: Kind-Modi (verletzt, wütend, impulsiv), maladaptive Bewältigungsmodi (Unterwerfung, Vermeidung, Überkompensation), dysfunktionale Eltern-Modi (strafend, fordernd) und der Gesunde-Erwachsenen-Modus. Das Ziel ist, den gesunden Erwachsenen zu stärken."
---
...
Verwandte Artikel: [Bindungstrauma heilen](/blog/bindungstrauma-heilen-erwachsene/), [IFS in der Partnerschaft](/blog/ifs-internal-family-systems-beziehung/), und [Emotionale Entbehrung in der Kindheit überwinden](/blog/emotionale-vernachlaessigung-beziehung/).

Deine Lebensfallen haben dich lange geführt. Es ist Zeit, dass du sie führst.
