---
title: "Boo Test & Erfahrungen 2026: Dating nach MBTI — Pseudoscience oder Volltreffer?"
description: "Boo im ehrlichen Test 2026: MBTI-Matching, Kosten, Community und echte Erfahrungen. Die Persönlichkeits-Dating-App auf dem Prüfstand."
date: 2026-04-19
image: "/images/blog/boo-test-erfahrungen.webp"
imageAlt: "Boo-Homepage – Screenshot 2026"
tags:
  - "Dating-Apps"
  - "Online-Dating"
  - "Boo"
  - "MBTI"
keywords: ["boo test", "boo erfahrungen", "boo app", "boo mbti dating", "boo 2026", "boo kosten", "boo alternative", "mbti dating app", "persönlichkeits dating", "boo vs okcupid"]
draft: false
author: "laura-weber"
faq:
  - question: "Kann man wirklich nach MBTI daten?"
    answer: "Jein. MBTI ist wissenschaftlich umstritten — die akademische Psychologie hält den Test für wenig reliabel, weil Menschen bei Wiederholung oft in anderen Typen landen. Trotzdem funktioniert MBTI als Gesprächseinstieg und Selbstreflexions-Werkzeug. Auf Boo bekommst du mit dem Typ einen ersten Anker, der Small Talk ersetzt: Statt 'Was machst du beruflich?' geht es direkt in 'Bist du eher der Planer oder spontan?' Viele Paare berichten, dass sie über MBTI erstmals über ihre Kommunikationsstile gesprochen haben. Als ernsthaftes Matching-Kriterium ist MBTI aber zu schwach — die Chemie entscheidet am Ende offline."
  - question: "Was kostet Boo+ Premium 2026?"
    answer: "Boo+ kostet im Monatsabo aktuell 9,99 €, im 3-Monats-Paket ca. 7,99 €/Monat und im Jahresabo rund 4,99 €/Monat. Es gibt auch ein Lifetime-Angebot für etwa 79,99 € einmalig, das regelmäßig im Sale angeboten wird. Die Preise sind damit deutlich günstiger als bei Tinder Gold, Bumble Premium oder Hinge+. Zusätzlich gibt es einzelne Boosts (ab 2,99 €) und 'Super Likes' als In-App-Käufe. Alle Preise variieren je nach iOS/Android, Region und Promo-Aktion."
  - question: "Wie funktioniert das MBTI-Matching bei Boo genau?"
    answer: "Boo ordnet jedem User nach Selbsttest einen der 16 MBTI-Typen zu (z. B. INFJ, ENTP, ISTJ). Der interne Algorithmus berechnet dann einen Kompatibilitäts-Score auf Basis bekannter 'Typen-Theorien' — zum Beispiel die Idee, dass intuitive Typen (N) gut mit anderen N-Typen harmonieren, oder dass INTJ und ENFP als 'goldene Paare' gelten. Zusätzlich fließt das Enneagramm-Ergebnis ein und optional Astrologie. Der Score ist kein harter Cut-Off — du siehst auch Profile mit niedrigerer Kompatibilität, sie erscheinen nur später im Stapel."
  - question: "Ist Boo in Deutschland, Österreich und der Schweiz beliebt?"
    answer: "Die DACH-User-Base ist kleiner als in den USA, UK oder Südostasien — dort ist Boo riesig. In Deutschland schätzen wir die aktive User-Zahl 2026 auf 150.000 bis 300.000 — damit deutlich kleiner als Tinder, Bumble oder Hinge. In Großstädten wie Berlin, München, Köln und Hamburg findest du trotzdem genug aktive Profile, vor allem in der Altersgruppe 18–28. Auf dem Land oder in mittelgroßen Städten wird's aber dünn — oft nur wenige Dutzend Profile im Umkreis. Für ernsthafte Partnersuche in der Provinz ist Boo deshalb keine erste Wahl."
  - question: "Ist MBTI wissenschaftlich belegt?"
    answer: "Nein, nicht wirklich. Der Myers-Briggs-Type-Indicator wurde in den 1940ern von Mutter und Tochter Briggs-Myers entwickelt — beide ohne psychologische Ausbildung, basierend auf Carl Gustav Jungs Typenlehre. Die moderne Persönlichkeitsforschung nutzt stattdessen das 'Big Five'-Modell (OCEAN), das empirisch validiert ist. Kritikpunkte an MBTI: niedrige Test-Retest-Reliabilität (bis zu 50 % landen beim zweiten Mal in anderen Typen), binäre Dichotomien statt Kontinuum, Barnum-Effekt. Trotzdem ist MBTI massentauglich, weil es einfach, catchy und auf sozialen Medien teilbar ist — eine Art Persönlichkeits-Horoskop."
  - question: "Ist Boo nur eine Dating-App?"
    answer: "Nein — das ist tatsächlich eine Besonderheit. Boo ist gleichzeitig Dating-App, Freundschafts-App und Community-Plattform. Du kannst in den Einstellungen angeben, ob du nach Dates, Freundschaften oder beidem suchst. Zusätzlich gibt es 'Lounges' — Discord-ähnliche Gruppenchats, sortiert nach MBTI-Typ oder Interesse. Dort triffst du andere INFJ-Nutzer, diskutierst über Memes oder Beziehungsthemen. Das macht Boo für introvertierte Gen-Z-Nutzer interessant, die vor dem 1:1-Dating lieber erstmal in einer Gruppe chatten. Für reine Dating-Sucher ist diese Community-Komponente eher ablenkend."
  - question: "Für wen ist Boo geeignet, für wen nicht?"
    answer: "Boo passt gut zu Menschen zwischen 18 und 28, die Pop-Psychologie mögen, auf TikTok MBTI-Content konsumieren und sich gerne über Persönlichkeit austauschen. Auch introvertierte Nutzer finden hier weniger Spam und mehr Text-Chat als auf Tinder. Wer dagegen über 30 ist, MBTI für Hokuspokus hält oder in kleineren Städten lebt, wird mit Boo wenig Freude haben. Auch für ernsthafte Partnersuche mit Heiratsabsicht ist Boo zu playful — hier sind xLoves, Parship oder ElitePartner besser."
  - question: "Was ist der Unterschied zwischen Boo und OkCupid?"
    answer: "OkCupid ist der 'erwachsene Bruder' von Boo: Beide setzen auf Persönlichkeits-Fragen statt nur Fotos, aber OkCupid hat über 1.000 optionale Fragen, deren Antworten in einen Kompatibilitäts-Score einfließen. Boo reduziert das auf MBTI + Enneagramm, ist also deutlich oberflächlicher aber auch schneller. OkCupid hat eine ältere, oft politischere Zielgruppe (25–40, häufig progressiv), Boo ist Gen-Z-lastig (18–28, MBTI-TikTok-Kultur). Wer Persönlichkeits-Tiefe will, ist auf OkCupid besser. Wer schnell swipen und in Communities chatten will, bei Boo."
  - question: "Ist die App wirklich kostenlos nutzbar?"
    answer: "Ja. Die Boo-Gratis-Version ist überraschend gut: Du kannst swipen, matchen, chatten, Lounges beitreten und deinen MBTI-Test machen — alles ohne Bezahlung. Ein Tages-Swipe-Cap existiert (ca. 20 Swipes/Tag), kann aber durch Tages-Login oder Video-Anschauen verlängert werden. Was Premium bringt: unbegrenzte Swipes, 'Wer hat mich geliked', erweiterte Filter (z. B. nur N-Typen anzeigen), Profilbesucher-Liste und werbefreies Browsen. Für viele Nutzer reicht die Gratis-Version völlig aus — besonders wenn du in einer größeren Stadt wohnst und ohnehin nicht hundert Swipes pro Tag brauchst."
  - question: "Kann ich meinen MBTI-Typ auf Boo später ändern?"
    answer: "Ja. Du kannst den Test jederzeit neu machen und deinen Typ aktualisieren — oder ihn manuell auf einen anderen Typ setzen, wenn du deinen 'echten' Typ schon kennst. Einige Nutzer wechseln regelmäßig zwischen zwei Typen (z. B. INFJ und INTJ), weil sie sich unsicher sind. Boo warnt dich aber, wenn du zu oft wechselst — der Algorithmus braucht Stabilität, um sinnvolle Matches vorzuschlagen. Tipp: Mach den Test einmal ehrlich, verlass dich auf das Ergebnis und konzentriere dich aufs eigentliche Daten. Zu viel Typen-Hopping macht dich in der App unsichtbar."
---
...
1. **Selbstoptimierungs-Kultur** — Gen Z liebt es, sich in Schubladen zu sortieren, um sich selbst "zu verstehen"
2. **Community-Zugehörigkeit** — "Als INFJ" ist identitätsstiftend, wie früher "als Widder" oder "als Hufflepuff"
3. **Gesprächseinstieg** — MBTI ersetzt Small Talk: Statt "Was machst du?" geht's direkt in Werte, Denkstile, Vorlieben
4. **Social-Media-Teilbarkeit** — "INTJ problems"-Memes, "ENFP energy"-Posts, Typen-Tier-Listen — alles geht viral
5. **Anti-Tinder-Protest** — viele Gen-Z-User sind Tinder-müde und suchen nach etwas Tieferem
...
1. Der Perfektionist
2. Der Helfer
3. Der Erfolgsorientierte
4. Der Individualist
5. Der Beobachter
6. Der Loyalist
7. Der Enthusiast
8. Der Herausforderer
9. Der Friedensliebende
...
1. **MBTI-Kompatibilität** (stärkste Gewichtung)
2. **Enneagramm-Paarung**
3. **Gemeinsame Interessen** (Hobbys, Musik, Bücher)
4. **Alter und Standort**
5. **Aktivität in der App** (aktive User werden bevorzugt angezeigt)
6. **Astrologie** (optional, schwach gewichtet)
...
1. **Niedrige Test-Retest-Reliabilität** — Studien zeigen, dass 30–50 % der Menschen beim zweiten Test (nach einigen Wochen) in einem anderen Typ landen. Ein reliabler Test sollte stabil sein.
2. **Keine Vorhersagekraft** — MBTI korreliert schwach bis gar nicht mit realem Beziehungs-Erfolg, Job-Performance oder Lebenszufriedenheit.
3. **Binäre Dichotomien** — Menschen sind keine "I oder E", sondern auf einem Kontinuum. MBTI zwingt in Schubladen, die die Realität vereinfachen.
4. **Barnum-Effekt** — Die Beschreibungen sind so allgemein formuliert, dass sich fast jeder wiedererkennt (wie bei Horoskopen).
5. **Fehlende akademische Grundlage** — Die Erfinderinnen (Katharine Briggs und Isabel Myers) waren keine ausgebildeten Psychologinnen. Ihre Typologie basiert auf Carl Gustav Jungs Theorien, die selbst stark kritisiert werden.
...
1. **Chat-Qualität hoch:** Die Antworten waren in 70 % der Fälle länger als 50 Zeichen — deutlich besser als Tinder-Standard ("Hey", Emoji-Antworten)
2. **MBTI-Gespräche dominieren Anfang:** Die ersten 5–10 Nachrichten drehen sich fast immer um Typen-Fragen ("Als INFJ, wie gehst du mit Konflikten um?")
3. **Schwache Kleinstadt-Performance:** In Wochenend-Tests in Leipzig und Nürnberg fielen die Matches um 70 % ein
4. **Lounges fressen Zeit:** 15 min Dating-Scroll, 40 min Lounge-Chat — das Verhältnis war kaputt
5. **Wenig Foto-Fokus:** Niemand schrieb uns "Du siehst gut aus" — fast immer wurde auf Bio oder Typ reagiert
...
Du magst die Idee, auf Persönlichkeit zu daten — aber die Pseudo-Science und die kleine DACH-Base nerven dich? Dann ist [xLoves](/top-dating-seiten) die erwachsenere Version:
...
**Die klare Empfehlung:** Wenn du **Persönlichkeits-Tiefe** magst, aber Boo zu gimmicky findest, schau dir [xLoves](/top-dating-seiten) an — **ausführliche Profile, keine Pseudo-Science**. Dort zahlst du zwar etwas mehr, bekommst aber **verifizierte Profile, echte DACH-Community und keinen MBTI-Zirkus**.

**[xLoves und alle seriösen Dating-Seiten im Vergleich](/top-dating-seiten)**
...
**Alternative: Wenn du Persönlichkeits-Tiefe magst aber Boo zu gimmicky findest, schau dir [xLoves](/top-dating-seiten) an — ausführliche Profile, keine Pseudo-Science.**

**[Alle seriösen Dating-Seiten im Vergleich 2026](/top-dating-seiten)**
