---
title: "HER Test & Erfahrungen 2026: Die Dating-App für queere Frauen im ehrlichen Check"
description: "HER im ehrlichen Test 2026: Kosten, Community-Features, Verifikation und echte Erfahrungen. Die größte LGBTQ+-Dating-App für Frauen auf dem Prüfstand."
date: 2026-04-19
image: "/images/blog/her-test-erfahrungen.webp"
imageAlt: "HER-Homepage – Screenshot 2026"
tags:
  - "Dating-Apps"
  - "LGBTQ+"
  - "HER"
  - "Queer Dating"
keywords: ["her test", "her erfahrungen", "her app", "weareher", "her dating", "lesben dating app", "queer dating app", "her 2026", "her premium", "her alternative"]
draft: false
author: "laura-weber"
faq:
  - question: "Ist HER wirklich nur für Frauen?"
    answer: "HER richtet sich explizit an lesbische, bi, queer, trans, nonbinary Frauen und queere Menschen — cis Männer sind nicht zugelassen. Das wird über eine Kombination aus Gender-Selbstauskunft, Community-Moderation und (seit 2023) Video-Verifikation durchgesetzt. Trans Frauen sind ausdrücklich willkommen, und nonbinäre Menschen können ihre Identität frei angeben. In der Praxis heißt das: HER ist eine der wenigen Apps weltweit, die wirklich als queerer Safe-Space konzipiert ist — auch wenn die Durchsetzung nicht perfekt ist und gelegentlich Fake-Profile durchrutschen."
  - question: "Was kostet HER Premium 2026?"
    answer: "HER ist in der Basisversion kostenlos nutzbar. HER Premium kostet aktuell rund 14,99 € pro Monat im Monatsabo, im Jahresabo sinkt der Preis auf etwa 8,99 € pro Monat. HER Pro (die höhere Stufe) liegt bei ca. 24,99 € pro Monat und schaltet zusätzlich erweiterte Filter, Incognito-Modus und bevorzugte Sichtbarkeit frei. Preise variieren leicht je nach Store (iOS meist teurer als Android), Region und laufenden Aktionen. Du kannst jederzeit über den App Store oder Play Store kündigen."
  - question: "Wie gut funktioniert HER in Deutschland?"
    answer: "HER ist in Berlin, Hamburg, München und Köln durchaus lebendig, besonders während CSD-Saison und Pride-Events. Außerhalb der Großstädte wird es schnell dünn — in Städten unter 100.000 Einwohnern siehst du oft nur eine Handvoll aktive Profile im Umkreis von 50 km. Wenn du auf dem Land lebst, musst du den Suchradius stark erweitern oder zusätzlich andere Apps nutzen. Der Community-Teil (Events, Gruppen) ist international stärker als der lokale DACH-Teil."
  - question: "Sind auf HER wirklich keine Männer?"
    answer: "Offiziell nein — cis Männer sind gesperrt. In der Praxis kommt es trotzdem vor, dass sich Männer als Frauen ausgeben, um auf die Plattform zu kommen (Voyeurismus, Ausspähen von Ex-Partnerinnen, Fetischisierung lesbischer Beziehungen). HER hat 2023 Video-Verifikation eingeführt, aber das Problem ist nicht vollständig gelöst. Die Community meldet solche Profile meist schnell, und das Support-Team reagiert relativ zügig. Trotzdem: Null Fake-Profile gibt es auf HER nicht."
  - question: "Wer darf ein HER-Profil anlegen?"
    answer: "HER ist offen für: cis lesbische Frauen, bisexuelle Frauen, pansexuelle Frauen, queere Frauen, trans Frauen, nonbinäre Menschen, genderqueere Personen und alle, die sich als Teil der LGBTQ+-Community für Frauen und queere Menschen verstehen. Explizit nicht zugelassen: cis heterosexuelle Männer. Paare (zum Beispiel für Swinging oder Unicorn-Hunting) sind zwar technisch möglich, werden aber von der Community kritisch gesehen und oft gemeldet."
  - question: "HER oder Tinder — was ist für lesbische Frauen besser?"
    answer: "Wenn du wirklich einen queeren Safe-Space suchst, ist HER besser. Auf Tinder bekommst du zwar mehr Matches (größere Community), aber auch viele Profile von neugierigen heterosexuellen Paaren, die ein Unicorn suchen, und gelegentlich Männer, die trotz Tinder-Filter durchrutschen. HER ist kleiner, aber die Community ist homogener queer und der Ton respektvoller. Für DACH empfehle ich oft: beide parallel, wobei HER die Haupt-App ist und Tinder als Reichweitenverstärker dient."
  - question: "Was sind die Communities und Events auf HER?"
    answer: "HER ist mehr als eine Dating-App — es gibt Communities (thematische Gruppen wie Sapphic Books, Queer Parents, Ace Spectrum, BIPOC Queer Community), Events (lokal und global, oft Pride-bezogen) und News-Feeds mit queer-relevanten Themen. Das ist einer der großen USPs der App. Die Qualität der Communities ist international sehr gut, in DACH aber eher überschaubar. Die meisten deutschsprachigen Stammtische finden informell über den lokalen Feed statt."
  - question: "Wie sicher ist HER in Sachen Datenschutz?"
    answer: "HER ist ein US-Unternehmen (Sitz London, Server teils USA), das heißt voller DSGVO-Schutz ist eingeschränkt. Die App sammelt Standortdaten, Profilinhalte und Chats. Positiv: HER nutzt keine Facebook-Pflichtanmeldung mehr, bietet Two-Factor-Auth und hat eine transparente Privacy-Policy. Für besonders sensible Nutzerinnen (z. B. noch nicht geoutete Personen) gibt es einen Incognito-Modus und die Möglichkeit, das Profil nur für bestimmte Regionen sichtbar zu machen. Kritisch bleibt: vollständige Anonymität wie auf deutschen Plattformen gibt es hier nicht."
  - question: "Wie kündige ich HER Premium?"
    answer: "HER Premium wird über den Apple App Store (iOS) oder Google Play Store (Android) abgerechnet — dort musst du auch kündigen. Das Löschen der App beendet das Abo NICHT. iOS: Einstellungen → Apple-ID → Abonnements → HER → Kündigen. Android: Play Store → Profil → Zahlungen & Abos → HER → Abo kündigen. Die Kündigung ist jederzeit ohne Frist möglich, Premium läuft bis zum Ende des bezahlten Zeitraums. Dein HER-Profil bleibt bestehen, wird aber auf die Gratis-Stufe zurückgestuft."
  - question: "Wer ist HER-Gründerin Robyn Exton?"
    answer: "Robyn Exton gründete HER 2015 in London, ursprünglich unter dem Namen 'Dattch'. Sie war frustriert davon, dass es für lesbische Frauen kaum sichere, seriöse Dating-Apps gab — die meisten Angebote richteten sich entweder an Männer, die ein Drittel-für-Paare suchten, oder waren technisch veraltet. HER ist heute die weltweit größte Dating- und Community-App für queere Frauen mit mehreren Millionen Nutzerinnen international. Exton ist nach wie vor CEO und gilt in der queeren Tech-Szene als eine der wichtigsten Stimmen für LGBTQ+-Dating-Produkte."
---
...
1. **Safe-Space-Claim** — cis heterosexuelle Männer sind komplett ausgeschlossen, die Plattform ist ein "Women and non-binary only space"
2. **Community statt Matching** — HER ist nicht nur Dating-App, sondern auch Event-Plattform, News-Feed und Gruppen-Tool in einer App
3. **Queer-Aware-Design** — erweiterte Gender- und Orientation-Angaben (Lesbian, Bi, Pan, Ace, Demi, Queer, Trans, Nonbinary, Genderfluid …), keine Hetero-Normativität in den Voreinstellungen
...
1. **Login per E-Mail, Handynummer oder Apple/Google** — keine Facebook-Pflicht mehr (seit 2021 entfernt, weil Facebook nicht mehr als Queer-Safe-Space wahrgenommen wurde)
2. **Gender-Identity** — freie Auswahl aus rund 30 Optionen (Woman, Trans Woman, Non-binary, Genderfluid, Genderqueer, Agender, etc.), inkl. Custom-Feld
3. **Sexual Orientation** — Lesbian, Bi, Pan, Queer, Ace, Demi, Questioning, Fluid, mehrere parallel möglich
4. **Pronouns** — she/her, they/them, he/him (für Trans-Männer in der Community), Custom
5. **Beziehungsziel** — Dating, Freundschaft, Community, neu in der Stadt, LTR, ENM/poly, casual
6. **Fotos** — mindestens 2, empfohlen 4–6; Pride-Fahnen und queer-identifizierende Bilder ausdrücklich erlaubt
7. **Profilfragen / Prompts** — ähnlich wie Hinge, z. B. "Ein queerer Film, den jeder gesehen haben sollte …", "Mein Safe-Space ist …"
8. **Video-Verifikation** (optional seit 2023) — kurzes Selfie-Video mit bestimmten Kopfbewegungen, wird per KI mit Profilfotos abgeglichen
9. **Community-Interests** — welche Communities/Gruppen interessieren dich (Sapphic Books, Queer Parents, BIPOC Community, Outdoor, etc.)
...
Wer in einer Kleinstadt lebt und queere Partnerinnen sucht, ist oft mit einer **diversen, LGBTQ+-friendly Plattform wie [xLoves](/top-dating-seiten)** besser bedient — dort ist die Gesamt-Community größer, und der Anteil queerer Nutzerinnen im Flächenland reicht oft für den Anfang.
...
1. **Cis Männer, die sich als Frauen ausgeben.** Das ist das häufigste Problem. Motivationen reichen von Voyeurismus über Ex-Partnerinnen-Stalking bis zu Fetischisierung lesbischer Beziehungen. Männer geben sich als Frauen aus, laden gestohlene oder generierte Fotos hoch und hoffen, die Verifikation zu umgehen.

2. **Paare, die ein "Unicorn" suchen, ohne das transparent zu machen.** Hetero-Paare, bei denen der Mann sich hinter dem Profil der Frau versteckt, um später zu überraschen. Explizit gegen die HER-Regeln — kommt trotzdem vor.

3. **Scam-Profile.** Klassische Romance-Scams wie auf Tinder: emotionale Bindung aufbauen, dann Geldanforderung (Notlage, Reisekosten, "Investment"-Tipp). Seltener auf HER als auf Mainstream-Apps, aber vorhanden.

4. **Bot-Profile für Weiterleitung.** Profile, die schnell nach Match auf Instagram, OnlyFans oder externe Sites weiterleiten wollen.
...
- **Wenn HER in deiner Region zu klein ist, schau dir die diverse Community auf [xLoves](/top-dating-seiten) an — auch LGBTQ+-Friendly.** Die Plattform hat eine deutlich größere Gesamtreichweite, eine wachsende LGBTQ+-Untercommunity und funktioniert auch im Flächenland. Für queere Frauen, die HER primär aus Reichweiten-Gründen nicht zufriedenstellt, ist das eine seriöse Alternative.

**[Alle Dating-Seiten im Vergleich 2026 ansehen](/top-dating-seiten)**
...
*Dieser Artikel wurde zuletzt aktualisiert am 19. April 2026. Preise und Angaben laut HER-Website (weareher.com), HER Support Center und öffentlichen Quellen. Herzblatt Journal ist unabhängig und erhält keine Vergütung von HER. Einige Empfehlungs-Links (z. B. zu xLoves) sind Affiliate-Links — wenn du dich darüber anmeldest, erhalten wir eine kleine Provision, für dich entstehen keine zusätzlichen Kosten. Unsere Bewertung ist davon unabhängig. Der Artikel versucht, queer-aware und respektvoll zu formulieren — für Feedback und Korrekturen sind wir jederzeit dankbar.*

## Weiterführende Artikel

- [Queer Dating 2026: Die besten Apps für LGBTQ+-Menschen im Vergleich](/blog/queer-dating-apps-2026)
- [Als queere Frau online daten: Tipps für mehr Sicherheit](/blog/queer-online-dating-tipps)
- [Coming-out und Dating: Wann und wie du es kommunizierst](/blog/coming-out-dating)
