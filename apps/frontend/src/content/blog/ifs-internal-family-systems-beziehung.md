...
faq:
  - question: "Was ist IFS einfach erklärt?"
    answer: "IFS (Internal Family Systems) ist ein Therapiemodell von Richard Schwartz. Es geht davon aus, dass unsere Psyche aus vielen inneren Anteilen besteht — wie eine innere Familie. Drei Hauptrollen: Manager (kontrollieren), Feuerwehrleute (löschen Schmerz), Exilanten (tragen alte Verletzungen). Im Zentrum steht das Self — dein ruhiger, mitfühlender Kern. Heilung heißt: das Self führt die Anteile, nicht umgekehrt."
  - question: "Kann IFS Paartherapie ersetzen?"
    answer: "Nein, aber es ergänzt sie enorm. IFS hilft dir zu verstehen, dass nicht du auf deinen Partner reagierst, sondern dein verletzter kleiner Anteil auf seinen verteidigenden Anteil. Wenn beide das erkennen, werden Streits anders. Für tiefere Themen oder akute Krisen brauchst du trotzdem einen ausgebildeten Therapeuten."
  - question: "Was ist der Unterschied zwischen einem Anteil und einer Emotion?"
    answer: "Eine Emotion ist eine Reaktion — Angst, Wut, Scham. Ein Anteil ist eine komplette innere Figur mit eigener Geschichte, eigener Stimme, eigenen Zielen. Anteile haben Alter (oft jünger als du), Perspektiven und Schutzstrategien. Eine Emotion fühlst du. Einen Anteil kannst du fragen, was er braucht — und bekommst Antworten."
  - question: "Wie weiß ich, ob ich gerade aus dem Self oder aus einem Anteil heraus spreche?"
    answer: "Das Self erkennst du an den sogenannten 8 Cs: Calm, Curious, Compassionate, Confident, Courageous, Creative, Clear, Connected. Wenn du ruhig, neugierig und mitfühlend bist, bist du im Self. Wenn du verteidigst, angreifst, rechtfertigst oder erstarrst, spricht ein Anteil. Das ist nicht schlimm — das Ziel ist nicht, nie in Anteilen zu sein, sondern Anteile zu kennen."
  - question: "Kann ich IFS allein anwenden oder brauche ich einen Therapeuten?"
    answer: "Beides geht. Für leichte Themen und Selbstbeobachtung kannst du mit Büchern (Jay Earley, Richard Schwartz) und Übungen gut allein starten. Bei tiefen Traumata, schweren Exilanten oder wenn du dich beim Arbeiten überwältigt fühlst, ist ein IFS-ausgebildeter Therapeut dringend empfohlen."
---
