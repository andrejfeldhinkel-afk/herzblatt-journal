...
import herzraumImagesUploadRoute from './routes/herzraum/images-upload.js';
import herzraumBackupRoute from './routes/herzraum/backup.js';
import herzraumSessionMapLiveRoute from './routes/herzraum/session-map-live.js';
...
app.route('/herzraum/images', herzraumImagesUploadRoute);
app.route('/herzraum/backup', herzraumBackupRoute);
app.route('/herzraum/session-map-live', herzraumSessionMapLiveRoute);
