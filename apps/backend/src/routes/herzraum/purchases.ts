 ...
 *
 * Liste aller E-Book-Käufe für das Dashboard.
 * Session-Cookie-protected (unter /herzraum/* mit requireSession mounted).
 *
 * Query: ?limit=100 (max 500, default 100)
 * Response: {
 *   total, paid, refunded, chargeback,
 *   revenue_cents: {all, paid, refunded},
 *   items: [{id, provider, orderId, email, product, amountCents, currency, status, createdAt}]
 * }
 */
