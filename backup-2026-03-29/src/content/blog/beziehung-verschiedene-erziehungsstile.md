...
1. **Sprecht über Erziehung, bevor ihr Kinder habt**: Das ist wichtig. Verstehe die Werte deines Partners zum Thema Erziehung.

2. **Respektiere die Erziehung deines Partners**: Auch wenn sie anders ist, respektiere sie (solange es nicht schadhaft ist).

3. **Findet Konsens bei kritischen Dingen**: Sicherheit, Bildschirmzeit, grundlegende Regeln.

4. **Unterstütze deinen Partner vor dem Kind**: Auch wenn du nicht ganz agree, zeige dem Kind dass dieser Parent auch wichtig ist.

5. **Sprecht regelmäßig**: Wie geht die Erziehung? Was funktioniert? Was nicht? Adjustt zusammen.

6. **Holt euch Hilfe wenn nötig**: Ein Family Counselor kann helfen, unterschiedliche Stile zusammen zu bringen.

7. **Erinnere dich: Das ist kein Wettkampf**: Ihr beide liebt das Kind. Das ist was zählt. Die Methoden können unterschiedlich sein.
...
- [Eule und Lerche – Wenn Partner verschiedene](/blog/beziehung-verschiedene-schlafrhythmen/)
