...
faq:
  - question: "Was ist die Polyvagal-Theorie einfach erklärt?"
    answer: "Die Polyvagal-Theorie von Stephen Porges beschreibt, wie unser autonomes Nervensystem auf Sicherheit und Gefahr reagiert. Sie unterscheidet drei Zustände: den sozialen Verbindungsmodus (ventraler Vagus), den Kampf-oder-Flucht-Modus (Sympathikus) und den Erstarrungsmodus (dorsaler Vagus). In Beziehungen entscheidet dieser innere Zustand oft darüber, ob wir Nähe zulassen, explodieren oder uns zurückziehen."
  - question: "Was bedeutet Koregulation in einer Beziehung?"
    answer: "Koregulation heißt, dass zwei Nervensysteme sich gegenseitig beruhigen. Wenn dein Partner ruhig und präsent ist, kann dein eigenes System das spüren und sich entspannen — über Atmung, Stimme, Augenkontakt, Berührung. Säuglinge lernen Emotionsregulation komplett über Koregulation; als Erwachsene brauchen wir sie immer noch, auch wenn wir es selten benennen."
  - question: "Wie erkenne ich, in welchem Nervensystem-Zustand ich gerade bin?"
    answer: "Ventraler Vagus (Sicherheit): ruhige Atmung, weicher Blick, Interesse an deinem Gegenüber, Humor ist möglich. Sympathikus (Kampf/Flucht): Herzklopfen, angespannte Muskeln, enger Blick, Drang zu reden oder zu gehen. Dorsaler Vagus (Erstarrung): Benommenheit, innere Leere, Dissoziation, Rückzug, Müdigkeit, das Gefühl 'abgeschaltet' zu sein."
  - question: "Kann man das Nervensystem gezielt beruhigen?"
    answer: "Ja, und das ist der Kern der praktischen Anwendung. Kaltes Wasser ins Gesicht, tiefes Ausatmen (doppelt so lang wie das Einatmen), Summen oder Singen, Augenkontakt mit einer sicheren Person, sanfte Berührung am Brustbein — all das aktiviert den ventralen Vagus. Regelmäßiges Üben erweitert dein sogenanntes 'Window of Tolerance'."
  - question: "Hilft Polyvagal-Arbeit bei Bindungstrauma?"
    answer: "Ja, sehr. Bindungstrauma entsteht meist in Phasen, in denen Koregulation fehlte oder unberechenbar war. Der Körper lernt dann, Nähe mit Gefahr zu verknüpfen. Polyvagal-informierte Therapie und gezielte Partnerübungen können dem Nervensystem beibringen, dass sichere Nähe möglich ist — Schritt für Schritt, nicht als Gedanke, sondern als körperliche Erfahrung."
---
