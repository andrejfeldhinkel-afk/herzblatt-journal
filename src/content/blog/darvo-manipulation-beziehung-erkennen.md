...
faq:
  - question: "Was bedeutet DARVO?"
    answer: "DARVO steht für Deny (Leugnen), Attack (Angreifen), Reverse Victim and Offender (Täter-Opfer-Umkehr). Es ist eine Manipulationsstrategie, bei der Täter sich als Opfer darstellen und das tatsächliche Opfer zum Täter machen."
  - question: "Wer hat DARVO erforscht?"
    answer: "Die Psychologin Jennifer Freyd hat DARVO als systematische Reaktion auf Konfrontation mit eigenem Fehlverhalten identifiziert und benannt. Ihre Forschung zeigt, dass DARVO besonders in Machtgefälle-Beziehungen auftritt."
  - question: "Ist DARVO Gaslighting?"
    answer: "DARVO enthält Elemente von Gaslighting, ist aber spezifischer. Gaslighting bezweifelt deine Realitätswahrnehmung generell. DARVO wird gezielt eingesetzt, wenn der Täter mit seinem Verhalten konfrontiert wird."
  - question: "Wie reagiere ich auf DARVO?"
    answer: "Erstens: Erkenne das Muster. Zweitens: Bleibe bei den Fakten. Drittens: Lass dich nicht in die Verteidigungsposition drängen. Viertens: Dokumentiere Vorfälle. Fünftens: Suche dir Unterstützung von außen."
  - question: "Kann DARVO unbewusst passieren?"
    answer: "Ja, manche Menschen haben DARVO als Verteidigungsmechanismus verinnerlicht, ohne es bewusst einzusetzen. Das macht es nicht weniger schädlich, aber es bedeutet, dass nicht jeder DARVO-Anwender ein bewusster Manipulator ist."
---
...
**A**ttack — Angreifen
**R**everse — Umkehren
**V**ictim and **O**ffender — Opfer und Täter
...
1. **"Das habe ich nicht gesagt."** — Das ist klassisches Gaslighting-Denial.

2. **"Du verdrehst immer meine Worte."** — Das legt deine Wahrnehmung an. Das ist Denial mit Gaslighting.

3. **"Du bist einfach zu emotional."** — Das diskreditiert deine Gefühle. Das ist Attack und Denial kombiniert.

4. **"Das ist dein Problem, nicht meines."** — Das ist Blame-Shifting mit Denial.

5. **"Ich kann nicht mit dir reden, weil du immer wütend wirst."** — Das macht dich zum Problem. Das ist die Reverse-Phase von DARVO.

6. **"Deine Ex hat das gleiche Problem mit dir."** — Das ist ein Angriff auf dein Selbstwertgefühl. Das ist Attack.

7. **"Ich versuche, dir zu helfen und du brauchst nur Therapie."** — Das ist ein Angriff auf deine psychische Stabilität. Das ist Attack mit einer Dosis Denial.

8. **"Andere Frauen wären froh, mich zu haben."** — Das ist ein Angriff auf dein Selbstwertgefühl. Das ist auch eine implizite Drohung (ich kann dich ersetzen).

9. **"Du tust mir weh mit deinem Misstrauen."** — Das ist die Reverse-Phase. Du wirst jetzt zum Täter, weil du nicht vertraust.

10. **"Ich bin hier das Opfer, nicht du."** — Das ist die vollständige Reverse-Phase. Das ist DARVO in seiner reinsten Form.
...
- Lese auch: [Dark Triad und Dating: Erkenne narzisstische Manipulation](/blog/dark-triad-dating-erkennen)
- Lese auch: [Silent Treatment in Beziehungen: Die stumme Strafe](/blog/silent-treatment-beziehung)
- Lese auch: [Trauma Bonding: Verstehe deine emotionale Abhängigkeit](/blog/trauma-bonding-erkennen-loesen)
