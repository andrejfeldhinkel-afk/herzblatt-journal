...
faq:
  - question: "Was ist die Freeze Response?"
    answer: "Die Freeze Response ist eine automatische Überlebensreaktion des Nervensystems. Bei wahrgenommener Bedrohung — auch emotionaler — erstarrt der Körper buchstäblich: Sprache, Denken und Handlungsfähigkeit werden blockiert."
  - question: "Warum erstarre ich bei Beziehungskonflikten?"
    answer: "Dein Nervensystem bewertet den Konflikt als Bedrohung, gegen die weder Kampf noch Flucht möglich scheint. Die Erstarrung ist ein Schutzprogramm aus der Kindheit, keine bewusste Entscheidung."
  - question: "Ist Freeze das Gleiche wie Stonewalling?"
    answer: "Nein. Stonewalling ist ein bewusster oder halbbewusster Rückzug, oft als Machtmittel. Freeze ist eine unwillkürliche Nerven­system-Reaktion — du KANNST buchstäblich nicht sprechen, auch wenn du willst."
  - question: "Wie komme ich aus dem Freeze raus?"
    answer: "Körperliche Bewegung ist der schnellste Weg: aufstehen, Hände schütteln, kaltes Wasser ins Gesicht. Das Nervensystem braucht ein körperliches Signal, dass die Gefahr vorbei ist."
  - question: "Kann mein Partner mir helfen, aus dem Freeze zu kommen?"
    answer: "Ja — durch ruhige Präsenz, keine Forderungen, sanfte Berührung (wenn erwünscht) und Geduld. Das Schlimmste ist Druck: 'Sag doch endlich was!' verstärkt die Erstarrung."
---
...
**Fawn** ist die Besänftigung. Das ist die "vergiss deine Grenzen, sei lieb, sei angepasst"-Reaktion. Du stimmst allem zu, nur um den Konflikt zu beenden. Du ignorierst deine eigenen Bedürfnisse völlig. Es ist eine Form der Unterwerfung. Fawner übernehmen oft die emotionale Last einer Beziehung, um Harmonie zu bewahren. (Wenn dich Fawn interessiert, lies unseren tieferen Guide unter [/blog/fawn-response-beziehung-guide](/blog/fawn-response-beziehung-guide).)
...
- **Langsam ausatmen:** Atme 4 Sekunden ein, 6-7 Sekunden aus. Das längere Ausatmen aktiviert den Parasympathikus. Tu das täglich für 5-10 Minuten, und nach Wochen wird dein Ruhe-Nervensystem trainierter.

- **Humming oder Singen:** Das vibrierten des Vagusnerves (durch Humming oder Singen) aktiviert und trainiert ihn. Es ist eines der einfachsten Dinge, die du tun kannst. Summe für 2-3 Minuten. Dein Nervensystem wird beruhigt.

- **Halskompression:** Eine sanfte Massage oder ein leichter Druck an der Seite deines Halses (wo der Vagusnerv vorbeiläuft) kann ihn aktivieren. Tu das nie aggressiv, aber sanfte Berührung kann helfen.
...
- **Suche spezifisch:** Nicht "Psychotherapeut", sondern "Trauma-informierter Therapeut" oder "Somatic Experiencing Practitioner" oder "EMDR Therapist."

- **Frag nach Erfahrung:** "Hast du Erfahrung mit Freeze und Nervensystem-Dysregulation?" Ein guter Therapeut wird das erkennen und sofort wissen, wovon du sprichst.

- **Ein erstes Gespräch:** Die meisten Therapeuten bieten ein kurzes Telefongespräch an. Nutze es. Stelle Fragen. Achte darauf, ob der Therapeut zuhört oder nur in seinen Skript spricht.

- **Vertrau deinem Bauch:** Wenn sich die erste Sitzung nicht richtig anfühlt, versuche jemand anderes. Therapeutische Beziehung ist wichtig.

- **Kombination ist oft am besten:** Viele Menschen brauchen sowohl Einzeltherapie (um ihr Nervensystem zu heilen) als auch Paartherapie (um die Beziehung zu heilen).
...
1. **Verstehe es.** Du erstarrst nicht, um zu stonewall oder dich zurückzuziehen. Du erstarrst, weil dein Nervensystem ein altes Programm ausführt. Vergebung für dich selbst ist der erste Schritt.

2. **Lehre es deinem Partner.** Erkläre, was Freeze ist. Zeige ihm diese Artikel. Hilf ihm zu verstehen, dass es nicht persönlich gegen ihn ist.

3. **Etabliere Protokolle.** Das Codewort, das Time-Out, die Post-Konflikt-Reparatur. Struktur hilft.

4. **Verwende die körperlichen Techniken.** Wenn Freeze kommt, stehe auf, schüttle deine Hände, spritz kaltes Wasser, atme. Dein Körper ist dein Werkzeug zur Genesung.

5. **Erweitere dein Toleranzfenster.** Mit sicherer Bindung, mit Exposition und mit körperorientierten Praktiken.

6. **Hol dir Hilfe.** Wenn du alte Trauma hast, arbeite mit einem Therapeuten, der SE, EMDR oder körperorientierte Therapie praktiziert. Das ist nicht schwäche. Das ist Intelligenz.
...
- [Polyvagaltheorie für Paare: Wie dein Nervensystem deine Beziehung prägt](/blog/polyvagal-theorie-paare-beziehung)
- [Stonewalling in Beziehungen: Unterschied zu Freeze und wie man es behebt](/blog/stonewalling-beziehung)
- [Fawn Response in Beziehungen: Wenn du dich selbst aufgibst um den Frieden zu halten](/blog/fawn-response-beziehung-guide)
