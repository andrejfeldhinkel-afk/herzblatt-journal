...
faq:
  - "{'question': 'Ist es gesund, nach einem Streit zu schweigen?', 'answer': 'Kurzfristig ja – dein Nervensystem braucht Zeit, sich zu beruhigen. Aber längerfristig schweigen vergiftet die Beziehung. Eine Pause ist okay. Permanente Funkstille ist nicht.'}"
  - "{'question': 'Wie lange sollte die Stille nach einem Streit dauern?', 'answer': 'Typically 15 Minuten bis eine Stunde. Das gibt beide Personen Zeit, emotional runterfahren. Alles länger als 24 Stunden wird problematisch – es wird zu stille Strafe.'}"
  - "{'question': "Was ist der Unterschied zwischen einer 'Pause' und 'Stonewalling'?", 'answer': "Eine Pause: Du sagst 'Ich brauche einen Moment.' Du kommst zurück. Stonewalling: Du wirst zur Mauer, sagst nichts, ignierst die Person. Es gibt keine Zeitrahmen, kein Plan zurück."}"
  - "{'question': 'Was soll ich tun, wenn mein Partner nicht mit mir reden will?', 'answer': "Gib ihm Raum, aber keine Manipulation. Sag: 'Ich brauche, dass wir später reden.' Wenn er weigert sich, tagelang zu reden, ist das ein Problem, das Therapie braucht."}"
  - "{'question': 'Wer sollte das erste Gespräch nach einem Streit anfangen?', 'answer': "Es muss nicht die 'verlierende' Person sein. Der erste, der bereit ist, sollte initiieren. Wenn keiner initiiert, ist das ein Problem. Nach 24 Stunden sollte jemand sagen: 'Können wir reden?'"}"
---
...
Das ist nicht Schweigen als Problem. Das ist Pausen als [heilung](/blog/aengstlicher-bindungsstil-heilen/).
...
**Nach 2-3 Tagen** – Das ist problematisch. Das ist nicht Pause. Das ist Strafe. Das ist emotionale Distanzierung, die [beziehung](/blog/adhs-und-beziehung-komplett-guide/) beschädigt.
...
Ein Partner denkt: "Er sollte zuerst entschuldigen, weil er schuldig ist."
Der andere Partner denkt: "Sie sollte entschuldigen, weil sie zu emotional war."
...
"Mir ist wichtig, dass wir wieder reden. Ich bin nicht einverstanden mit dir, aber ich bin nicht bereit, in dieser Stille zu sein."
...
Sieh dir auch an: [Stonewalling verstehen](/blog/stonewalling-was-tun/), [faire Konfliktlösung](/blog/streiten-ohne-verletzen/), und [schwierige Gespräche führen](/blog/beziehungs-gespraeche-fuehren/).

Am Ende: Eine kurze Pause nach einem Streit ist normal und wahrscheinlich gesund. Aber Stille kann nicht die Lösung sein. Die Lösung ist Rückkehr. Rückkehr zum anderen. Rückkehr zur Kommunikation. Rückkehr zur Beziehung.
