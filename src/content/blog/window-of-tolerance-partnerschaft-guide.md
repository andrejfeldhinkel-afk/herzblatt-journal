...
faq:
  - question: "Was ist das Window of Tolerance?"
    answer: "Das Window of Tolerance (Toleranzfenster) ist ein Konzept von Dan Siegel. Es beschreibt den Bereich, in dem du Stress und Emotionen verarbeiten kannst, ohne in Hyperarousal (Überaktivierung) oder Hypoarousal (Erstarrung) zu kippen."
  - question: "Warum ist das Toleranzfenster für Beziehungen wichtig?"
    answer: "In Beziehungen triggern Konflikte und Nähe unser Nervensystem. Ein enges Toleranzfenster führt zu schnellen Überreaktionen oder Rückzug. Je weiter dein Fenster, desto gelassener kannst du Beziehungsherausforderungen begegnen."
  - question: "Kann man sein Toleranzfenster erweitern?"
    answer: "Ja, durch regelmäßige Übungen wie Atemtechniken, Achtsamkeit, Körperarbeit und sichere Beziehungserfahrungen. Jede positive Erfahrung innerhalb des Fensters macht es etwas weiter."
  - question: "Wie erkenne ich, dass ich außerhalb meines Toleranzfensters bin?"
    answer: "Typische Zeichen sind: Herzrasen, flache Atmung, Tunnelblick (Hyperarousal) oder Taubheit, Abschalten, Gefühl von Leere (Hypoarousal). In Beziehungen zeigt sich das als Streit-Eskalation oder emotionaler Rückzug."
  - question: "Was passiert wenn beide Partner gleichzeitig ihr Toleranzfenster verlassen?"
    answer: "Das ist die häufigste Ursache für eskalierende Streits. Wenn beide dysreguliert sind, kann niemand den anderen koregulieren. Hier helfen vereinbarte Time-Outs und individuelle Regulationsstrategien."
---
...
- Ruhige Atmung: "Atme mit mir." Wenn eine Person ruhig atmet und die andere bemerkt es, synchronisieren sich die Atemrhythmen. Das beruhigt das ganze Nervensystem.

- Physischer Kontakt: Eine Hand auf der Schulter. Ein Umarmen. Das aktiviert den dorsalen Vagus (den beruhigenden Teil des Nervensystems) — aber nur, wenn es sicher ist. Wenn der dysregulierte Partner Berührung braucht, nicht Distanz.

- Augenkontakt: Ruhiger, präsenter Blick. Das sagt deinem Nervensystem: "Ich sehe dich. Du bist nicht allein."

- Stimme: Eine ruhige, warme, langsame Stimme. Nicht patronisierend. Nur ruhig.

- Emotionale Verfügbarkeit: "Sag mir, was du brauchst. Ich bin hier."
...
**Schritt 1**: Mach die Toleranzfenster-Map (30 Minuten allein)
**Schritt 2**: Teile sie mit deinem Partner und hört einander zu (keine Defensivität, nur Verstehen)
**Schritt 3**: Wählt eine der 12 Übungen und macht sie täglich für eine Woche
**Schritt 4**: Bemerkt, wie euer Nervensystem reagiert. Wird es einfacher, ruhig zu bleiben?
...
1. **Das Toleranzfenster ist dein Sweet Spot**: Es ist der Bereich, in dem dein Nervensystem optimal funktioniert — du kannst klar denken, empathisch sein, ruhig bleiben.

2. **Es wurde in deiner Kindheit geprägt**: Sichere Bindung führt zu breiten Fenstern, unsichere Bindung zu engen Fenstern. Das ist nicht dein Fehler, sondern deine Überlebensgeschichte.

3. **Es gibt zwei Zonen außerhalb**: Hyperarousal (Überaktivierung: Wut, Panik, Kampf) und Hypoarousal (Unteraktivierung: Erstarrung, Shutdown, Rückzug).

4. **Deine Beziehungs-Dynamik hängt davon ab**: Pursuer-Withdrawer ist fast immer ein Fenster-Mismatch. Ein Partner hyperaroused, einer hypoaroused.

5. **Koregulation ist deine Superpower**: Ein ruhiger, präsenter Partner kann dein Nervensystem beruhigen. Das ist biologisch real.

6. **Die 12 Übungen funktionieren**: Atemtechnik, Grounding, progressive Muskelrelaxation, TIPP-Skills — sie erweitern dein Fenster messbar über Zeit.

7. **Es braucht Zeit und Konsistenz**: 3 Monate regelmäßige Arbeit, und du wirst einen signifikanten Unterschied bemerken.

8. **Professionelle Hilfe ist nicht Versagen**: Wenn dein Fenster durch Trauma verengt ist, ist Therapie nicht optional — es ist die schnellste Route zur Veränderung.
